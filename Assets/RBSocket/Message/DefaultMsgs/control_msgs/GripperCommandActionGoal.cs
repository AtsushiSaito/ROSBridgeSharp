...
{
    [System.Serializable]
    public class GripperCommandActionGoal : ExtendMessage
    {
        public RBS.Messages.std_msgs.Header header;
        public RBS.Messages.actionlib_msgs.GoalID goal_id;
        public RBS.Messages.control_msgs.GripperCommandGoal goal;
        public override string Type() { return "control_msgs/GripperCommandActionGoal"; }
